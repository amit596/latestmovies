...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002483299948 -1001769437975 -1001855645227 -1002329403438').split()]  # For Multiple Id Use One Space Between Each.
